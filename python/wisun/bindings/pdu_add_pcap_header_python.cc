...
#include <pdu_add_pcap_header_pydoc.h>

void bind_pdu_add_pcap_header(py::module& m)
{

    using pdu_add_pcap_header = ::gr::wisun::pdu_add_pcap_header;


    py::class_<pdu_add_pcap_header,
               gr::block,
               gr::basic_block,
               std::shared_ptr<pdu_add_pcap_header>>(
        m, "pdu_add_pcap_header", D(pdu_add_pcap_header))

        .def(py::init(&pdu_add_pcap_header::make),
             py::arg("prepend_global_pcap_header"),
