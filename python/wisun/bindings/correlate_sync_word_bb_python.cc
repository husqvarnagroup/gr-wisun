...
void bind_correlate_sync_word_bb(py::module& m)
{
    ...
    py::class_<correlate_sync_word_bb, gr::sync_block, gr::block, gr::basic_block,
        std::shared_ptr<correlate_sync_word_bb>>(m, "correlate_sync_word_bb", D(correlate_sync_word_bb))
